...
| Custom LUT | Implementation verified; activation pending | User1–User16 storage, CUBE parsing, import sequences, LUT selection and display paths exist. First isolated experiment: `0x02cf1443=01`. |
